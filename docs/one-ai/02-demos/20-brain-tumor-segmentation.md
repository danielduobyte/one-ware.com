...
To try this demo, click on the **Try Demo** button below. If you do not have an account yet, you will be prompted to sign up. After logging in, the quick start overview will open where you can select the **Brain Tumor Segmentation** project. Once installed, ONE WARE Studio will open automatically.
:::
