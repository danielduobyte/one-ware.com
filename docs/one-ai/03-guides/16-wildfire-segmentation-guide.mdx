---
id: wildfire-segmentation-guide
title: Wildfire Segmentation Guide
...
This guide uses the Wildfire dataset to demonstrate the complete segmentation workflow:
