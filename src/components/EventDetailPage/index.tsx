...
export default function EventDetailPage({ event, onBack }: EventDetailPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#161616]">
      ...
      >
        <div className="w-full max-w-[95%] mx-auto px-6 md:px-12 lg:px-16">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[55%] h-[50vh] lg:h-[70vh] flex items-center justify-center">
              <img
      ...
      <div className="w-full max-w-[95%] mx-auto px-6 md:px-12 lg:px-16 py-16">
        <div className="max-w-6xl mx-auto space-y-12">
          {localizedEvent.highlights && localizedEvent.highlights.length > 0 && (
          ...
          {localizedEvent.agenda && localizedEvent.agenda.length > 0 && (
            <div className="p-6 md:p-8 bg-white/5 rounded-2xl border border-white/10">
              <h2 className="text-2xl font-bold text-[var(--ifm-color-primary)] mb-6">
          ...
          {localizedEvent.sections && localizedEvent.sections.map((section, index) => (
            <div key={index} className="p-6 md:p-8 bg-white/5 rounded-2xl border border-white/10">
          ...
          {localizedEvent.tables && localizedEvent.tables.length > 0 && (
            <div className="p-6 md:p-8 bg-white/5 rounded-2xl border border-white/10">
              <h2 className="text-2xl font-bold text-[var(--ifm-color-primary)] mb-6">
                          ...
                          {table.columns.map((col, colIdx) => (
                            <th
                              ...
                              className={`py-4 text-[var(--ifm-color-primary)] font-medium text-sm ${
                                col.format === "date"
                                  ? "pr-4 whitespace-nowrap w-[180px]"
                                  : colIdx === 1
