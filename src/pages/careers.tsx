                ...
                >
                  <div className="flex items-center pt-6 pb-2 pr-8 md:pr-12 transition-all duration-300" style={{ borderBottom: "1px solid #6b7280" }}>
                    ...
                    <span className="flex-grow flex justify-center">
                      <span className="w-72 md:w-96 text-left">
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gray-200 p-12 pb-6 overflow-hidden">
              <div
              ...
              >
                <div className="grid grid-cols-[11fr_9fr] gap-24">
                  <div className="flex flex-col justify-center">
                    <p className="text-gray-600 text-base md:text-lg italic leading-relaxed min-h-[8rem]">
                      "{EMPLOYEE_STORIES[displayedStory].quote}"
                    </p>

                    <div className="mt-8 flex items-start gap-8">
                      <span className="text-[var(--ifm-color-primary)] text-5xl md:text-6xl font-bold italic" style={{ lineHeight: 0.7 }}>
                        "
                      </span>
                      <div className="space-y-1">
                        ...
                        <span className="text-gray-500 text-sm md:text-base block">
                          {EMPLOYEE_STORIES[displayedStory].position}
                        </span>
                        <span className="text-[var(--ifm-color-primary)] text-sm md:text-base block">
                          {EMPLOYEE_STORIES[displayedStory].cyanText}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-center gap-6 mb-6">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <div
                  key={item}
                  className="w-32 h-10 bg-black transition-all duration-300 hover:scale-110 hover:opacity-80 cursor-pointer"
                />
              ))}
            </div>
