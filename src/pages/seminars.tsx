      ...
      <section id="events" className="bg-[#161616] pt-8 md:pt-12 pb-16 md:pb-24">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="rounded-2xl p-5 mb-12 overflow-visible bg-[#252525] border border-white/10">
              <div className="flex gap-4 items-end">
                ...
                <button
                  ...
                  className="button button--primary h-10 w-10 p-0 flex items-center justify-center flex-shrink-0"
                >
